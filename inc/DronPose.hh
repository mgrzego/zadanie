...
/*!
 * \brief Modeluje zestaw informacji określający pozę drona
 *
 *  Klasa modeluje zestaw informacji określających pozę drona.
...
class DronPose {
  public:
   /*!
    * \brief Zeruje pozę drona
    *
    *  Inicjalizuje wartościami 0 zarówno pozycję drona,
